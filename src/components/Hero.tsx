...
export default function Hero() {
  ...
  return (
    <section className="relative min-h-[90vh] pt-20 flex items-center overflow-hidden">
      {/* Background blobs */}
      <div className="blob top-0 left-0 opacity-50"></div>
      <div className="blob bottom-0 right-0 opacity-40"></div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-center">
          <div className="md:col-span-7 space-y-8">
            <div className="space-y-5">
              <div
                className={cn(
                  "inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-theme-100 text-theme-800 transition-all",
              ...
              <h1
                className={cn(
                  ...
                  mounted ? "animate-fade-in opacity-100 delay-100" : "opacity-0"
                )}
              >
                Hi, I'm <span className="text-theme-500 text-glow">Pranjal Lohia</span>
                <br />
              ...
              <p
                className={cn(
                  ...
                  mounted ? "animate-fade-in opacity-100 delay-200" : "opacity-0"
                )}
              >
            ...
            <div
              className={cn(
                ...
                mounted ? "animate-fade-in opacity-100 delay-300" : "opacity-0"
              )}
            >
              <Button 
            ...
            <div
              className={cn(
                "mt-10",
                mounted ? "animate-fade-in opacity-100 delay-400" : "opacity-0"
              )}
            >
              ...
              <div className="flex flex-wrap gap-2">
                {skills.map((skill, index) => (
                  <div
                    key={skill}
                    className="px-3 py-1 bg-secondary text-foreground rounded-full text-sm animate-fade-in"
          ...
          <div className="md:col-span-5 flex justify-center">
            <div
              className={cn(
                ...
                mounted ? "animate-fade-in opacity-100 delay-500" : "opacity-0"
              )}
            >
              {/* Profile image with design elements */}
              <div 
                className="absolute inset-0 rounded-3xl overflow-hidden border-4 border-background shadow-xl animate-float"
                style={{
                  transform: `translate3d(${position.x * -2}px, ${position.y * -2}px, 0)`,
                }}
              >
                <img 
                  src="/lovable-uploads/1721ddc2-7428-4c2c-ae13-cbb883a45cc6.png" 
                  alt="Pranjal Lohia" 
              ...
              <div 
                className="absolute top-10 -left-10 bg-white p-2 rounded-lg shadow-lg animate-bounce-subtle"
                style={{
                  animationDelay: '0.5s',
              ...
              <div 
                className="absolute bottom-10 -right-5 bg-white p-2 rounded-lg shadow-lg animate-bounce-subtle"
                style={{
                  animationDelay: '1s',
